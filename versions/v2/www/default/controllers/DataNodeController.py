...
class DataNodeController(NodeController):
	...
	@endpoint(1, False, True, None, "get", "^/api/chains", "Get chains")
	...
	@endpoint(1, False, True, None, "get", "^/api/(?P<chainid>[0-9a-f][^-&*/\%]*)/transactions/(?P<classid>[0-9a-f][^-&*/\%]*)/key/(?P<key>[0-9a-z_-][^&*/\%]*)/(?P<value>[0-9a-z_-][^&*/\%]*)", "Get transactions for block for key with value")
