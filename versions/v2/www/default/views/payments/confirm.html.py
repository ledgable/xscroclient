...
<section class="panel focus w600 blue">
	...
	<div class="content">
			...
			<section>
				...
				<form id="wallet__info" class="controldata">
					...
					<ul class="fields">
						...
						<li><span class="highlight">Amount: <strong class="right">20 ICURY</strong></span></li>

						<li><span class="highlight">Current Balance: <strong class="right">200 ICURY</strong></span></li>

						<li>After payment you will have</li>

						<li><span class="highlight">Balance: <strong class="right">180 ICURY</strong></span></li>
		...
		<ul class="clear">
			<li class="action right">
				...
				<span class="button green upper" data-event="{'action':'Payments','event':'pay','args':{}}">Confirm Payment</span>
			</li>
		</ul>
	...
	<div class="bottom">
		<span><py>print(self.session.id_session, file=stdout)</py></span>
	</div>
